                    ...
                    <div class="row justify-content-center">
                        <div class="card bg-card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header">
                                <h3 class="text-center font-weight-light my-4">Ganti Pasword</h3>
                            </div>
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="">
                                        <a class="btn btn-dark d-flex justify-content-center text-dark" href="../index.php" style="background-color: #FFE401;">Ganti Password</a>
                                    </div>
                                </form>
                            </div>
