...
if (mysqli_ping($koneksi)) {
    ...
    $query = "SELECT no_id,alamat_pengirim,tanggal_surat,nomor_surat,perihal,tanggal_pelaksanaan,tempat,isi_disposisi	 FROM undangan LIMIT $start, $limit";
    ...
    if ($hasil) {
        ...
        // Pagination links
        $query_total = "SELECT COUNT(*) AS total FROM undangan";
        ...
        if ($page > 1) {
            echo "    <li class='page-item'><a class='page-link' href='undangan.php?page=" . ($page - 1) . "'>Previous</a></li>";
        } else {
        ...
        if ($page < $total_pages) {
            echo "    <li class='page-item'><a class='page-link' href='undangan.php?page=" . ($page + 1) . "'>Next</a></li>";
        } else {
