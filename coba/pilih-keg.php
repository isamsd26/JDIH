<div class="dropdown">
    <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <li><a class="dropdown-item" href="surat-masuk.php">Surat Masuk</a></li>
            <li>
            ...
            <li><a class="dropdown-item" href="agenda-masuk.php">Agenda Masuk</a></li>
            <li>
                 <hr class="dropdown-divider">
            </li>
            <li><a class="dropdown-item" href="agenda-ajuan.php">Agenda Ajuan</a></li>
            <li>
                 <hr class="dropdown-divider">
            </li>
