...
if ($hasil && mysqli_num_rows($hasil) > 0) {
    ...
    if ($page > 1) {
        ...
        echo "    <li class='page-item'><a class='page-link' href='agendaA.php?page=$previous_page'>Previous</a></li>";
    } else {
    ...
    if ($page < $total_pages) {
        $next_page = $page + 1;
        echo "    <li class='page-item'><a class='page-link' href='agendaA.php?page=$next_page'>Next</a></li>";
    } else {
